...
def endpoint_dist(prediction,full,partial,midpoint,rows,cols,edge2index,edge_index2tuple):
    ...
    while cur_point != (-1,-1):
        prev_point = cur_point
        cur_point,prev_edge = find_next_point(prev_edge,full,cur_point,rows,cols,edge2index,edge_index2tuple)
...
def main():
    ...
    #return
    total_guessed_more = (num_evaluated - total_only_guessed_one)
